# >---------------------------[ Install Command ]-----------------------------<
#  rails new APP_NAME -m http://railswizard.org/9808bd3b1353a8325011.rb -J  -T
# >---------------------------------------------------------------------------<
#
#            _____       _ _   __          ___                  _ 
#           |  __ \     (_) |  \ \        / (_)                | |
...
# |             |                                                             |
# | Name:       | teste template                                              |
# | URL:        | http://railswizard.org/9808bd3b1353a8325011.rb              |
# | Updated:    | November 03, 2010 at 13:05PM                                |
# |             |                                                             |
# |\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\|
#  ---------------------------------------------------------------------------
...
template = {"authentication"=>"devise", "templating"=>"haml", "unit_testing"=>"rspec", "css"=>"on", "javascript"=>"jquery", "integration_testing"=>"cucumber", "orm"=>"activerecord-1"}
